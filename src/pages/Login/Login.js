        ...
        <Grid container spacing={2}>
          ...
          <Grid item xs={12} sm={12} md={7} lg={7}>
            ...
            >
              ...
              <Stack mt={2} mb={3} className="text-center ">
              <Link to="/forgot-password" className='text-align'> Forgot Password? </Link>
              </Stack>
              <span className="text-sign">
                Don't have an account?<Link to="/signup" className='text-dark'>Signup</Link> 
              </span>
